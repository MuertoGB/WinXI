...
Public Class FormToast
    ...
    Private ReadOnly ColorInfo As Color = Colors.clrNotifyInfo
    Private ReadOnly ColorWarning As Color = Colors.clrNotifyWarn
    Private ReadOnly ColorError As Color = Colors.clrNotifyError
