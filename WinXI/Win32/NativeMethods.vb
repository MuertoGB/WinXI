...
'   08.03.2021 - DR - Added WritePrivateProfileString for IniFile.vb
...
NotInheritable Class NativeMethods
    ...
    <PreserveSig()>
    Friend Shared Function WritePrivateProfileString(Section As String, Key As String, Value As String, FileName As String) As Long
    End Function
